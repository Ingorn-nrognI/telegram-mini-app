...
export declare const FitzModifier: {
    readonly None: 0;
    readonly Type12: 1;
    readonly Type3: 2;
    readonly Type4: 3;
...
export declare const DEFAULT_RENDER_QUALITY: RenderQuality;
export type PlayerState = "idle" | "loading" | "ready" | "playing" | "paused" | "stopped" | "complete" | "error" | "destroyed";
export type PlayerEventName = "load" | "frame" | "loopComplete" | "complete" | "play" | "pause" | "stop" | "error" | "destroy";
